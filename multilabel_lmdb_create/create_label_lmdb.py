...
N = 420								# Number of data instances  
M = 17								# Number of possible labels for each data instance 
output_lmdb_path = '/multilabel/data/lmdbs/train_label_lmdb'   	   # Path of the output label LMDB
labels_mat_file = '/multilabel/data/labels_train.mat'              # Mat file for training iamge labels N x M 
# +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
...
X[:,:,0,0] = mat_contents['labels']		# here "labels" is the variable name stored in labels_mat_file
